...
element_model=r'./pathway_module/output/element/element_model.pth'
element_config_file=r'./pathway_module/Base-RetinaNet.yaml'
...
dictionary_path = r"./pathway_module/all_gene_names.json"
