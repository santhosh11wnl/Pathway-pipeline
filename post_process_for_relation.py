...
from relation_data_tool import register_Kfold_pathway_dataset
from OCR import OCR
...
def filter_invalid_relation_predictions(relation_prediction_file,datasetDict, element_instances, element_list, relation_instances, relation_list,
...
if __name__ == "__main__":
    ...
    filter_invalid_relation_predictions(rotated_relation_prediction_file,datasetDict, element_instances, element_list, rotated_relation_instances,
